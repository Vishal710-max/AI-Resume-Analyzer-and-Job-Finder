...
class ProfileUpdate(BaseModel):
    ...
    bio: Optional[str] = Field(None, max_length=500, description="Professional summary or bio")
    location: Optional[str] = Field(None, max_length=100, description="City, Country or location")
    timezone: Optional[str] = Field(None, max_length=50, description="Timezone (e.g., UTC, EST, PST)")
    profile_picture: Optional[str] = Field(None, description="Base64 encoded profile picture or URL")
    ...
    def validate_timezone(cls, v):
        valid_timezones = [
            'UTC', 'GMT', 'EST', 'CST', 'MST', 'PST', 'IST', 'JST', 'AEST',
            'UTC+1', 'UTC+2', 'UTC+3', 'UTC+4', 'UTC+5', 'UTC+5:30', 'UTC+6', 'UTC+7', 'UTC+8', 'UTC+9', 'UTC+10',
            'UTC-5', 'UTC-6', 'UTC-7', 'UTC-8', 'UTC-9', 'UTC-10'
        ]
        if v and v not in valid_timezones:
            return v  # Allow custom timezone format, just validate in frontend if needed
        return v
