...
# =======================================================
# REUSABLE FUNCTION TO DISPLAY CLICKABLE COURSE LINKS
# =======================================================

def display_courses(title, courses):
    """Displays courses with clickable links in a styled card layout."""
    st.subheader(title)

    for index, (course_name, course_url) in enumerate(courses, start=1):
        st.markdown(
            f"""
            <div style="margin-bottom: 12px; padding: 14px; border-radius: 10px; 
                        background-color: #0d1117; border: 1px solid #1f2937;">
                <span style="font-size:18px; font-weight:bold; color:#58a6ff;">
                    {index}. <a href="{course_url}" target="_blank" 
...
# =======================================================
#                COURSE LISTS (YOUR ORIGINAL DATA)
# =======================================================
